...
class DB_Manager:
    ...
    def default_insert(self):
        sql = 'INSERT OR IGNORE INTO skill (skill_name) values(?)'
        data = skills
...
JOIN project_skill ON projects.project_id = project_skill.project_id 
JOIN skill ON skill.skill_id = project_skill.skill_id 
